...
<link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo ROOT_URL.'public/assets/css/styles.css' ?>">
</head>
<body>
<style>
    body{
...
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
                <a href="<?php echo ROOT_URL."home" ?>" class="simple-text">
                    Quản Lý Đào Tạo
                </a>
            </div>
            ...
            <ul class="nav list_act">
                <li class="<?php if(isset($_SESSION['select']) && $_SESSION['select'] == '1') echo "active"; ?>">
                    <a class="nav-link d-flex" href="<?php echo ROOT_URL."home" ?>">
                        <i class="icon-th"></i>
                        <p>Danh sách người đăng ký </p>
                    </a>
                </li>
                
                <li  class="<?php if(isset($_SESSION['select']) && $_SESSION['select'] == '2') echo "active"; ?>">
                    <a class="nav-link d-flex" href="<?php echo ROOT_URL."home/interns" ?>">
                        <i class="icon-th"></i>
                        <p>đạt điều kiện đào tạo</p>
                    </a>
                </li>
                
                <li  class="<?php if(isset($_SESSION['select']) && $_SESSION['select'] == '3') echo "active"; ?>">
                    <a class="nav-link d-flex" href="<?php echo ROOT_URL."home/course" ?>">
                        <i class="icon-th"></i>
                        <p>Danh sách khóa đào tạo</p>
                    </a>
                </li>
        ...
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#" style="color: #000;">Công ty Cổ phần Phần mềm Quản lý Doanh nghiệp FAST</a>
                </div>
