            ...
            <div class="row">
                        <div class="col-md-8">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo ROOT_URL."admin/updateProfile/".$data['users']['id'] ?>" method="post">
                                        <div class="row">
                                            <div class="col-md-5 pr-1">
                                                <div class="form-group">
                                                    <label>Họ và Tên</label>
                                                    <input type="text" class="form-control" placeholder="Họ và Tên" name="ho_ten" value="<?php echo $data['users']['ho_ten'] ?>">
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="gioi_tinh" id="">
                                                        ...
                                                        <option value="nu" <?php if($data['users']['gioi_tinh'] == 'nu') echo "selected" ?> >Nữ</option>
                                                    </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 pr-1">
                                                <div class="form-group">
                                                    <label>Gmail </label>
                                                    <input type="email" class="form-control" placeholder="Gmail" name="gmail"  value="<?php echo $data['users']['gmail'] ?>">
                                        ...
                                        <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="hoc_van" id="hoc_van">
                                                        <option value="dh" <?php if($data['users']['hoc_van'] == 'dh') echo "selected" ?> >Đại Hoc</option>
                                                        <option value="cd" <?php if($data['users']['hoc_van'] == 'cd') echo "selected" ?> >Cao Đẳng</option>
                                                        <option value="tc" <?php if($data['users']['hoc_van'] == 'tc') echo "selected" ?> >Trung Cấp</option>
                                                        <option value="khac" <?php if($data['users']['hoc_van'] == 'khac') echo "selected" ?> >Khác</option>
                                                    </select>
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    <label>Chức Vụ</label>
                                                    <input type="text" class="form-control" placeholder="Chức Vụ" name="chuc_vu" value="<?php echo $data['users']['chuc_vu'] ?>">
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Tiền Lương" name="luong" value="<?php echo $data['users']['luong'] ?>">
                                        ...
                                        <button type="submit" name="btn-update" class="btn btn-info btn-fill pull-right">Cập Nhật Thông Tin</button>
